...
const FIXED_COLORS: ReadonlyArray<readonly [RegExp, RgbaColor]> = [
  ...
  [/(?:lamp|lantern|torch|glowstone|froglight|lit_pumpkin)/, color(255, 234, 50)],
  [
    /(?:^|:)(?:dispenser|dropper|hopper|observer|redstone_wire|(?:unpowered|powered)_(?:repeater|comparator)|daylight_detector(?:_inverted)?|lever|(?:sticky_)?piston|piston_head|piston_extension|tripwire_hook|trip_wire|tripwire|sculk_sensor)$/,
    color(216, 38, 38),
  ],
  ...
  [/(?:^|:)(?:crying_)?obsidian$/, color(13, 9, 23)],
  ...
  [/(?:^|:)(?:stone|infested_stone)$/, color(127, 127, 127)],
